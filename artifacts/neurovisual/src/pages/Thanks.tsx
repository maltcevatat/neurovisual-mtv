...
const TELEGRAM_URL =
  import.meta.env.VITE_TELEGRAM_INVITE_URL ||
  "https://t.me/+J3tB6UNtMHkyYzBi";
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-white/5">
        <div className="container mx-auto px-6 h-[60px] flex items-center justify-between">
          <Link
            href="/"
            className="text-[13px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground/80 font-light transition-colors"
      ...
      <main className="flex-1 flex items-center justify-center px-6 pt-20">
        ...
        >
          ...
          <p className="text-[15px] text-muted-foreground font-light leading-relaxed mb-10 max-w-md mx-auto">
            Добро пожаловать в курс «Нейровизуал от MTV». Доступ к обучению
            можно получить по кнопке ниже. Также письмо с доступом будет
            отправлено на email, который вы указали при оплате.
          </p>
          ...
          <div className="flex items-start gap-3 rounded-2xl bg-card/30 border border-white/6 px-6 py-4 max-w-sm mx-auto text-left">
            ...
            <p className="text-[13px] text-muted-foreground font-light leading-relaxed">
              Если письмо не пришло, проверьте папки{" "}
              <strong className="text-foreground/70 font-normal">Спам</strong>{" "}
              и{" "}
              <strong className="text-foreground/70 font-normal">
                Промоакции
              </strong>
              . По вопросам доступа напишите на{" "}
              <a
          ...
          <Link
            href="/"
            className="block mt-8 text-[13px] text-muted-foreground hover:text-foreground transition-colors font-light"
          >
